...
module.exports.login = async (req, res) => {
    ...
    if (!loginOrg) return RESPONSE(res,200,"Org Not Found")
    if (!compareSync(req.body.orgdata.password, loginOrg.password)) return RESPONSE(res,200,"Incorrect Email or Password")

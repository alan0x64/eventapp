...
typedef bodyfuntion = Widget Function(
    String query, int selectedCategory, int selectedStatus, int selectedType);

class Search extends SearchDelegate {
  final bodyfuntion body;
  ...
  Widget buildResults(BuildContext context) {
    return searchStructure(
      ...
      (query, selectedCategory, selectedStatus, selectedType) {
        return body(query, selectedCategory, selectedStatus, selectedType);
      },
    );
  }
...
Widget searchStructure(bodyfuntion body,
    {selectedType, categories, selectedCategory, selectedStatus, query}) {

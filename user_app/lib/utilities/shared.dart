// ignore_for_file: non_constant_identifier_names, null_argument_to_non_null_type, depend_on_referenced_packages, curly_braces_in_flow_control_structures
...
Map<String, dynamic> getUserFromForm(
  ...
  return {
    'fullName': formKey.currentState!.fields['fullName']!.value,
    'email': formKey.currentState!.fields['email']!.value,
    'phoneNumber': formKey.currentState!.fields['phoneNumber']!.value,
    'date_of_birth':
        formKey.currentState!.fields['date_of_birth']!.value.toString(),
    'university': formKey.currentState!.fields['university']!.value,
    'faculty': formKey.currentState!.fields['faculty']!.value,
    'department': formKey.currentState!.fields['department']!.value,
    'scientific_title': formKey.currentState!.fields['scientific_title']!.value,
    'bio': formKey.currentState!.fields['bio']!.value,
  };
}
...
Widget loadImageNet(String path, {bool profile = false}) {
  if (path.isEmpty) {
...
bool didFieldsChange(
  ...
  if (org_event_user != 2) if (object.location !=
      getLocationString(context, org_event_user)) {
    return true;
  }
